...
import type { ExportTarget } from '@cronwizard/shared';
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Advanced Mode</h1>
        <p className="text-muted-foreground">
          Enter a cron expression directly to validate, describe, and export.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        {nextRuns.length > 0 && (
          <div className="rounded-lg border bg-card p-4 space-y-2">
            <h3 className="text-sm font-medium text-muted-foreground">Next {nextRuns.length} Runs</h3>
